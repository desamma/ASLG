...
/// <summary>
/// Chakkram enemy Stats and Health
/// </summary>
[DisallowMultipleComponent]
public class Enemy_Chakkram_Health : MonoBehaviour, IEnemy_Health
{
    [Header("Enemy Stats")]
    ...
    private Enemy_Chakkram_Movement movementComponent;
    ...
    public void ChangeHealth(float amount)
    {
        ...
        else if (stats.CurrentHP <= 0)
        {
            ...
            if (movementComponent != null)
            {
                ...
                manager?.ChangeState(Enemy_Chakkram_State.Death);
            }
    ...
    {
        var data = EnemyDataRepository.LoadEnemy("Chakkram");
